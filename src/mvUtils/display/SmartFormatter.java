...
// taken from
// https://github.com/phylogeography/SPREAD/blob/master/src/utils/NumberFormatter.java
...
public class SmartFormatter {
    ...
    public SmartFormatter(int sf) {
        setSignificantFigures(sf);
    }

    public SmartFormatter(int sf, int fieldWidth) {
        setSignificantFigures(sf);
        setPadding(true);
